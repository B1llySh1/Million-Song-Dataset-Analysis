...
def main(inputs):
    ...
    pipeline = Pipeline(stages=[
        all_tf,
        final_assembler,
        KMeans(featuresCol='features', k=8)    # Optmized k
    ])
    ...
    print("Silhouette with squared euclidean distance with (kMean k=8) = " + str(silhouette))
    ...
    print("Generating clustering 2-D plot with kmean k=8 and PCA2.")
    # Pipeline
    ...
    # Clustering
    KMeans_=KMeans(featuresCol='features', k=8)  # Choose the number of cluster here
    ...
    """
    print("Generating clustering 3-D plot with kmean k=8 and and PCA3.")
    # Converting to 3-D
    ...
    """
    CrossTab the cluster with the artist term
    """
